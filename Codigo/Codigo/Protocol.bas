...
'Writes the "ChangeSpellSlot" message to the given user's outgoing data buffer
'27-08-2016: Shak@ Gracias a la optimizaci�n, enviamos menos datos :P
'***************************************************
On Error GoTo ErrHandler
    With UserList(UserIndex).outgoingData
...
'***************************************************
'@Shak: Creada el d�a 27-08-2016
'Utilizamos esto para enviar las palabras m�gicas
'***************************************************
    With auxiliarBuffer
